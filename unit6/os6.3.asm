...
// The functions are placed in the SYSCALLS table surrounded by JMP and NOP
  .file [name="os6.3.bin", type="bin", segments="XMega65Bin"]
...
// lpeek(dword zeropage($59) address)
lpeek: {
    .label t = $2f
    .label address = $59
...
// initialise_pdb(byte zeropage($f) pdb_number, byte* zeropage($14) name)
initialise_pdb: {
    .label __1 = $61
    .label __2 = $61
    .label __9 = $63
...
// memset(void* zeropage($57) str, byte register(X) c, word zeropage($14) num)
memset: {
    .label end = $14
    .label dst = $57
    .label num = $14
...
get_next_message_id: {
    .label receiver = $73
    .label m = $78
    .label best_message = $17
    lda #$ff
    sta.z best_message
    ldx #0
  __b1:
    cpx.z ipc_message_count
    bcc __b2
    rts
  __b2:
    txa
